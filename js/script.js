document.addEventListener('DOMContentLoaded', () => {
    const slides = [
        ...
        { id: 'slide-next-activity', duration: 10000, transition: 'fade' },
    ...
    let physicsInterval; // Declare interval variable outside
    ...
    const objectImages = [
        ...
        { src: 'assets/computer-set.png', min: 10, max: 25 },
    ...
    function initPhysicsAnimation() {
        ...
        clearInterval(physicsInterval); // Clear any existing interval
    ...
    function stopPhysicsAnimation() {
        clearInterval(physicsInterval); // Stop adding new objects
        if (engine) {
            setTimeout(() => {
            ...
            }, 500); // Delay to allow objects to fall off screen
        }
    }
